...
//console.log(abc[0]);
 ...
 return[abc[0],mulabc[0],`${a} and ${b} and ${c} sum to ${abc[0]}.` ,
  `The product of ${a} and ${b} and ${c} is ${mulabc[0]}.`]
}
...
//return[total2[0],`${testArray[0]} and ${testArray[1]} and ${testArray[2]} was passed in as an array of numbers and ${total2[0]},
//"is their sum.`]
}
}
sumArray(testArray);
